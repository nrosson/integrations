    ...
    <div className="max-w-3xl">
      ...
      <div className="bg-white border border-gray-200 rounded p-5 mb-5">
        ...
        {connection ? (
          <>
            <div className="grid grid-cols-2 gap-x-8 gap-y-3 pt-4 border-t border-gray-100">
              <div>
                ...
                <p className="text-xs text-gray-600">Company #{connection.companyId}</p>
              </div>
              <div>
              ...
              <div>
                <p className="text-xs text-gray-600 mb-0.5">{integration.externalIdLabel}</p>
                <p className="font-mono text-sm text-gray-700">{connection.realmId}</p>
              </div>
              <div>
                <p className="text-xs text-gray-600 mb-0.5">Last Refreshed</p>
          ...
          <p className="text-sm text-gray-600 pt-4 border-t border-gray-100">No active connection found for this integration.</p>
        )}
      </div>
      ...
      <div className="bg-white border-2 border-dashed border-gray-200 rounded p-5">
        ...
        {SlotComponent ? (
          ...
          <div className="flex flex-col items-center justify-center py-10 text-center">
            ...
            <p className="text-sm text-gray-600">No configuration component registered for this integration.</p>
            <p className="text-xs text-gray-600 mt-1">The integration team can drop their component here.</p>
          </div>
        )}
      </div>
    </div>
